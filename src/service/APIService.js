...
export const changePass = (current_password, new_password) => axios.post('api/v1/change-password',{current_password, new_password})

export const viewHistory = () => axios.get('api/v1/history')
